    ...
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            var fsql = new FreeSqlBuilder()
                .UseConnectionString(FreeSql.DataType.SqlServer, @"Data Source=.;Initial Catalog=rightcontrol;Persist Security Info=True;Connect Timeout=300;User ID=sa;Password=Zrcb108")
