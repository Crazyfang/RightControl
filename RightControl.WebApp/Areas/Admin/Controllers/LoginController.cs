...
namespace RightControl.WebApp.Areas.Admin.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(IUserService _userService, ILogService _logService, IDepartmentUserService _departmentuserService)
        {
        ...
        public ActionResult CheckLogin(string username, string password, string code)
        {
            ...
            try
            {
                ...
                if (userEntity != null)
                {
                    ...
                    var department = departmentuserService.GetDepartmentByUserId(userEntity.Id);
                    operatorModel.DepartmentName = department.DepartmentName;
                    operatorModel.DepartmentId = department.DepartmentId;
                    operatorModel.DepartmentCode = department.DepartmentCode;
