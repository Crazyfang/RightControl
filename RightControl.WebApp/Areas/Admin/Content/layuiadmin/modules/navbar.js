    ...
    function getChildHtml(data) {
        if (data!=undefined&& data.children != undefined && data.children.length > 0) {
            ...
            for (var j = 0; j < data.children.length; j++) {
                ulHtml += '<dd>';
                ulHtml += '<a data-id=' + data.children[j].id + ' href="javascript:;" data-url="' + data.children[j].href + '?id=' + data.children[j].id + '" lay-href="' + data.children[j].href + '?id=' + data.children[j].id + '">';
                if (data.children[j].icon !== undefined && data.children[j].icon !== '') {
                    if (data.children[j].icon.indexOf('icon-') !== -1) {
                        ulHtml += '<i class="layui-icon ' + data.children[j].icon + '" data-icon="' + data.children[j].icon + '" aria-hidden="true"></i>';
                    } else {
                        ulHtml += '<i class="layui-icon ' + data.icon + '" data-icon="' + data.children[j].icon + '"></i>';
                    }
                }
            ...
            if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
                ...
                if (data[i].icon !== undefined && data[i].icon !== '') {
                    if (data[i].icon.indexOf('icon-') == -1) {
                        ulHtml += '<i class="layui-icon icon-' + data[i].icon + '" aria-hidden="true" data-icon="' + data[i].icon + '"></i>';
                    } else {
