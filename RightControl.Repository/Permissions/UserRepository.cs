...
namespace RightControl.Repository
{
    public class UserRepository : BaseRepository<UserModel>, IUserRepository
    {
        ...
        public UserModel GetDetail(int Id)
        {
            ...
            {
                //var sql = "select u.*,r.RoleName from t_User u INNER JOIN t_role r on u.RoleId=r.Id AND u.Id=@Id LEFT JOIN t_DepartmentUser t on t.DepartmentId=@Id";
                var sql =
                    "select u.*,r.RoleName,d.DepartmentCode,d.DepartmentName,d.Id as DepartmentId from t_User u INNER JOIN t_role r on u.RoleId = r.Id AND u.Id = @Id LEFT JOIN t_DepartmentUser du on du.UserId = u.Id LEFT JOIN t_department d on d.Id = du.DepartmentId";
